...
sed -i 's|--with-mail --with-mail_ssl_module --with-stream --with-stream_realip_module --with-stream_ssl_module --with-stream_ssl_preread_module|--with-pcre-jit --with-select_module --with-poll_module --with-http_access_module --with-http_autoindex_module --with-http_browser_module --with-http_charset_module --with-http_empty_gif_module --with-http_limit_conn_module --with-http_memcached_module --with-http_mirror_module --with-http_referer_module --with-http_split_clients_module --with-http_scgi_module --with-http_ssi_module --with-http_upstream_hash_module --with-http_upstream_ip_hash_module --with-http_upstream_keepalive_module --with-http_upstream_least_conn_module --with-http_upstream_random_module --with-http_upstream_zone_module --with-openssl=$(CURDIR)/debian/modules/openssl|g' rules
cd ..
